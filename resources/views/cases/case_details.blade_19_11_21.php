                ...
                <div class="inner-one">
                    <div class="content p-4">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="button d-flex">
                                    ...
                                    <span style="margin-left: -35px;">
                                        <a href="{{ $data->document_url }}" target="_blank" class="btn btn-secondary ml-5"  class="btn btn-primary"
                            ...
                            <button type="submit" name="submit" class="btn btn-primary" style="float: right;background-color: #44CCFF;padding: 10px;padding-left: 20px;padding-right: 20px;margin-left: 20px;">Submit</button>
                            ...
                            <!-- <div class="btn">
                                ...
                                <label for="exampleFormControlInput1">Add new
                                    document for User</label>
                            </div> -->
                            <!-- <div class="col-md-9 mt-2">
                                <div class="button d-flex">
                                    ...
                                    <span><a href="#" class="badge"
                                            style="background-color: #44CCFF;color: black;padding: 10px;padding-left: 0px;padding-right: 0px;margin-left: 20px;padding-top: 0px;padding-bottom: 0px;">
                                            <input type="text" class="form-control"
                                                placeholder="Editable"
                                                style="background-color: transparent;border: none;" /></a></span>
                                    <span>
                                    ...
                                    <span>
                                        <button class="btn btn-secondary ml-5"
                                            style="font-size:11px;">Submit to
                                            Doc</button>
                                    </span>
                                </div>
                                <div class="area mt-2">
                                    <div class="form-group">
                                        <textarea class="form-control"
                                            id="exampleFormControlTextarea1"
                                            rows="2"
                                            placeholder="Comment for user"></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="button d-flex">
                                    <span>
                                        <div class="custom-control custom-switch pt-1"
                                            ...
                                            <input type="checkbox"
                                                class="custom-control-input"
                                                id="customSwitch6" value="Yes" name="status">
                                            <label class="custom-control-label"
                                                for="customSwitch6"></label>
                                        </div>
                                    </span>
                                    ...
                                    <span>
                                            <input type="text" class="form-control" name="document_type" placeholder="Editable" style="background-color: #44CCFF;color: black;padding: 10px;padding-left: 0px;padding-right: 0px;margin-left: 20px;padding-top: 0px;padding-bottom: 0px;" /></span>
...
style="margin-right: 60px;border-radius: 20px;padding: 0 22px 0 22px;">Save</button>
<button type="submit" class="btn btn-warning"
style="margin-right: 46px;border-radius: 20px;padding: 0 22px 0 22px;">Save</button>
...
if(@$eligibility_data->status == 'Yes'){
$checked = 'checked';
}else{
$checked = '';
}

if(@$eligibility_data->status == 'No'){
$unchecked = 'checked';
}else{
$unchecked = '';
}
...
<div class="btn-group btn-group-toggle" data-toggle="buttons" style="margin-left: 20px;">
  <label class="btn  active case-details-check">
    <input type="radio" id="status_yes" name="status" value="Yes" autocomplete="off" <?= $checked ?> /> Yes
  </label>
  <label class="btn  case-details-check">
    <input type="radio"  id="status_no" name="status" value="No" autocomplete="off" <?= $unchecked ?> /> No 
  </label>
</div>
...
rows="9"
placeholder="Type Something (Explanation)..." value="{{ @$eligibility_data->explanation }} " > {{ @$eligibility_data->explanation }} </textarea>
</div>
</div>
<div class="btn" style="float:right;">
<button type="submit" class="btn btn-warning"
...
<div class="contents p-2">
<div class="btn-content d-flex p-3">
<span style="padding-top:8px;">FINAL LOAN APPROVAL FROM
THE BANK</span>
</div>                                                    
...
<div class="form-group row">
    <label for="inputEmail3"
        ...
        (Receivable)</label>
    <div class="col-sm-10">
        <input type="text" name="loan_amount" value="{{ @$final_bank_approval->loan_amount }}" 
...
<div class="form-group row" style="margin-top: -1em;">
    <label for="inputEmail3"
        ...
        Rate</label>
    <div class="col-sm-10">
        <input type="text" name="interest_rate" value="{{ @$final_bank_approval->interest_rate }}" 
            class="form-control w-50"
            id="inputEmail3" style="border: none;">
    </div>
</div>
<div class="form-group row">
    <label for="inputEmail3"
        class="col-sm-2 col-form-label">Tenure</label>
    <div class="col-sm-10">
        <input type="text" name="tenure" value="{{ @$final_bank_approval->tenure }}"
            class="form-control w-50"
            id="inputEmail3" style="border: none;">
    </div>
</div>
<div class="form-group row">
    <label for="inputEmail3"
        ...
        Fees</label>
    <div class="col-sm-10">
        <input type="text" name="processing_fees" value="{{ @$final_bank_approval->processing_fees }}"
            class="form-control w-50"
            id="inputEmail3" style="border: none;">
    </div>
</div>
...
<div class="form-group row pt-3">
    ...
    <div class="col-xs-12 col-sm-12 col-lg-4">
        <label for="exampleFormControlSelect1">Type Of Product</label>
            <select class="form-control" id="exampleFormControlSelect1" name="select_loan">
...
<label for="exampleFormControlSelect1">Business Organization Type</label>
    <select class="form-control" id="exampleFormControlSelect1">
        ...
        <?php 
        foreach( $industry  as $key =>  $ind) { ?>
            <option value="<?=$ind->industry_name?>" <?php if($ind->industry_name == $cases->organisation_type){ echo "selected";} ?>  ><?=$ind->industry_name?></option>
        <?php } ?>
    </select>
</div>
<div class="col-xs-12 col-sm-12 col-lg-4 mb-3">
...
<input type="number" name="inform_client_income" value="<?=$cases->inform_client_income?>" class="form-control" />
</div>
<div class="col-xs-12 col-sm-12 col-lg-4 mb-3">
